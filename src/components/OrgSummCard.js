function OrgSummCard(props) {
  ...
  return(
    <div key={orgname}>   
      ...
      <p>Total to democratic candidates and party committees: {dems ? dems : 'N/A'}</p>
      <p>Total to republican candidates and party committees: {repubs ? repubs : 'N/A'}</p>
      ...
      <p>Total from 527 organizations: {tot527 ? tot527 : 'N/A'}</p>
